...
const AddRentalItemForm = ({ onClose, onAdd }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Check if either file upload or image URL is provided
          ...
          <div>
            ...
            <div className="mb-3">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Upload an image file (PNG, JPG, JPEG, AVIF) - Max 5MB
              </p>
            </div>
...
export default AddRentalItemForm;
